...
A fully functional Windows Server Active Directory environment built from scratch in a virtualized homelab. This project covers network infrastructure setup, DNS and DHCP configuration, domain deployment, and user/group management — documented end-to-end with screenshots.
...
- Group Policy / domain join — workstation enrollment and domain user login
- Cross-platform networking — Windows and Linux (Ubuntu) in the same domain environment
- Network troubleshooting — ipconfig, ping, ARP, nslook
